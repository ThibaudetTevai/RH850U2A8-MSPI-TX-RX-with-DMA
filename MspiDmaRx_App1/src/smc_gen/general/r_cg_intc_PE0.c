...
void R_Interrupt_Initialize_ForPE(void)
{
    ...
    INTC2.EIC250.UINT16 &= _INT_PRIORITY_LEVEL4;
    ...
    INTC2.EIC244.UINT16 &= _INT_PRIORITY_LEVEL5;
    INTC2.EIBD244.BIT.PEID = _INT_CPU_PE0;
    /* Set INTMSPI2ERR setting */
    INTC2.EIC267.BIT.EIMK267 = _INT_PROCESSING_DISABLED;
    INTC2.EIC267.BIT.EIRF267 = _INT_REQUEST_NOT_OCCUR;
    INTC2.EIC267.BIT.EITB267 = _INT_TABLE_VECTOR;
    INTC2.EIC267.UINT16 &= _INT_PRIORITY_LOWEST;
    INTC2.EIBD267.BIT.PEID = _INT_CPU_PE0;
    /* Set INTMSPI2FE setting */
    INTC2.EIC266.BIT.EIMK266 = _INT_PROCESSING_DISABLED;
    INTC2.EIC266.BIT.EIRF266 = _INT_REQUEST_NOT_OCCUR;
    INTC2.EIC266.BIT.EITB266 = _INT_TABLE_VECTOR;
    INTC2.EIC266.UINT16 &= _INT_PRIORITY_LOWEST;
    INTC2.EIBD266.BIT.PEID = _INT_CPU_PE0;
    /* Set INTMSPI2RX setting */
    INTC2.EIC265.BIT.EIMK265 = _INT_PROCESSING_DISABLED;
    INTC2.EIC265.BIT.EIRF265 = _INT_REQUEST_NOT_OCCUR;
    INTC2.EIC265.BIT.EITB265 = _INT_TABLE_VECTOR;
    INTC2.EIC265.UINT16 &= _INT_PRIORITY_LEVEL3;
    INTC2.EIBD265.BIT.PEID = _INT_CPU_PE0;
    ...
    INTC2.EIC47.UINT16 &= _INT_PRIORITY_LEVEL3;
