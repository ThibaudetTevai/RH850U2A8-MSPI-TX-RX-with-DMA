...
/***********************************************************************************************************************
* Function Name: R_Config_SDMAC01_Create
...
void R_Config_SDMAC01_Create(void)
{
    ...
    DMATRGSEL.DMACSEL0_7.UINT32 |= _DMAC_REQUEST_16M_5_GRP0;
    ...
    SDMAC0.DMA0TMR_1.UINT32 = _DMAC_TRANSFER_NORMAL_MODE | _DMAC_REQUEST_PRIORITY_DISABLE | _DMAC_HW_REQUEST | 
                              _DMAC_DESTINATION_ADDRESS_FIXED | _DMAC_SOURCE_ADDRESS_FIXED | 
    ...
    R_Config_SDMAC01_Create_UserInit();
}

/***********************************************************************************************************************
* Function Name: r_Config_SDMAC01_enable_pe0_interrupt
* Description  : This function enables DMAC01 interrupts for PE0.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void r_Config_SDMAC01_enable_pe0_interrupt(void)
{
...
/***********************************************************************************************************************
* Function Name: r_Config_SDMAC01_disable_pe0_interrupt
* Description  : This function disables DMAC01 interrupts for PE0.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void r_Config_SDMAC01_disable_pe0_interrupt(void)
{
...
/***********************************************************************************************************************
* Function Name: R_Config_SDMAC01_Start
...
void R_Config_SDMAC01_Start(void)
{
    ...
    r_Config_SDMAC01_enable_pe0_interrupt();
    /* Enable DMAC01 operation */
    SDMAC0.DMA0CHCR_1.UINT16 |= _DMAC_TRANSFER_ENABLE;
}

/***********************************************************************************************************************
* Function Name: R_Config_SDMAC01_Stop
...
void R_Config_SDMAC01_Stop(void)
{
    ...
    r_Config_SDMAC01_disable_pe0_interrupt();
    /* Synchronization processing */
    g_cg_sync_read = SDMAC0.DMA0CHCR_1.UINT16;
    __syncp();
}
...
/***********************************************************************************************************************
* Function Name: R_Config_SDMAC01_Suspend
...
/***********************************************************************************************************************
* Function Name: R_Config_SDMAC01_Resume
